      ...
      {generatingQuestion && (
        <div className="glass-panel rounded-2xl p-10 text-center flex flex-col items-center justify-center border border-slate-900 animate-slide-up">
          ...
          <p className="text-xs text-slate-400 max-w-sm">
            Gemini is analyzing your syllabus for <span className="text-violet-400 font-semibold">{selectedSubtopic || 'selected topic'}</span> to curate a {difficulty}-level challenge.
          </p>
        </div>
      )}
